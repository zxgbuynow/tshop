$(document).ready(function () {
    ...
    setTimeout(function(){new goodsSpecTree('.content');},1000);
    var GoodsSpec;
    var goods_info;
    var Products;
    var Spec = '{spec_props: null, selection_spec: null, activeSpec: null, selection_spec_json: null, products: false,selection_spec:null,selection_spec_json:null,spec_props:null}';
    var activeProducts;
    ...
    var goodsSpecTree = new Class({
        ...
        storeData: function(el, uid, prop, sib) {
          ...
          if(!$.isEmptyObject(goods_info)) {
            ...
            if(n && n[1]) {
              this.count = Math.max(this.count, n[1] + 1);
            }
          }
