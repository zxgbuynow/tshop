...
namespace plugins\TableBm;
use app\common\controller\Plugin;

/**
 * 表单报名插件
 * @package plugin\TableBm
...
class TableBm extends Plugin
{
    ...
    public $info = [
        ...
        'author'      => '周工',
        // 作者主页[选填]
        'author_url'  => 'http://www.zgbuynow.com',
